...
const {
    ...
    show_depto_info_extra, showDeptoSelect, doExportPDF, valueMonth, setValueMonth} = useExpensas()
  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-around align-items-center flex-wrap"> 
      <template v-for="(otro_pago ,index) in otros_pagos" :key="index">
        <input-component-vue :titleValue="`Pago Extra N° ${index+1}`" descriptionValue="$"
    ...
    <div class="d-flex justify-content-end mt-3">
      <button v-if="otros_pagos.length" type="button" class="btn btn-danger" @click="deleteNewPago"><font-awesome-icon icon="fa-solid fa-trash"/>
         Eliminar Ultimo Campo de Pago Extra </button>
    </div>
